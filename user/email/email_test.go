...
var (
	...
	issuerURL        = url.URL{Host: "authd.example.com"}
	fromAddress      = "authd@example.com"
	passwordResetURL = url.URL{Host: "authd.example.com", Path: "passwordReset"}
	verifyEmailURL   = url.URL{Host: "authd.example.com", Path: "verifyEmail"}
